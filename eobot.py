...
async def on_message(meassage):
    if meassage.content.startswith("도움말"):
        await meassage.channel.send("말을 걸면 돼 간단하지? ㅎㅇ , ㅂ2 , 잘지냉? , 고마웡 , 잘지냉?" , sep='\n'"아프지망! , 뭐행!? , 심심행! , 뭐하징!? , 어휴!! , 그!? , 힘들엉! ," sep='\n' "속상행! , 우울행! , 배고팡! , 잘장!-! 끝")
    ...
    if meassage.content.startswith("나 누나 좋아해 진심이얌!~!"):
        ...
        await meassage.channel.send("집안일 완전히끝나면 그때 보거나 다음에 봐요 누나ㅎㅎ 좋은 하루 되세요(좋은 밤되세요)")
